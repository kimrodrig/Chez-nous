                ...
                >
                    ...
                    >
                        ...
                        <div className="video-navlink">
                            <NavLink to="/reservations" className="hvr-wobble-top">
                                reservations
                            </NavLink>
                        </div>
                        <div className="video-navlink">
                            <NavLink to="/menu" className="hvr-wobble-top">
                                menu
                            </NavLink>
                        </div>
                        <div className="video-navlink">
                            <NavLink to="/about" className="hvr-wobble-top">
                                about
                            </NavLink>
                        </div>
                        <div className="video-navlink">
                            <NavLink to="/gallery" className="hvr-wobble-top">
                                gallery
                            </NavLink>
                        </div>                    
                        <div className="video-navlink">
                            <NavLink to="/signup" className="hvr-wobble-top">
                                subscribe
                            </NavLink>
                        </div>
                    </div>
                    ...
                    >
                        <a type="button" href="http://www.instagram.com/cheznousnyc" className="hvr-wobble-top">
                        ...
                        <a type="button" href="mailto:kim@cheznousnyc.com" className="hvr-wobble-top">
